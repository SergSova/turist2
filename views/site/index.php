                    ...
                    <div class="col s12 m6 l3">
                        <div class="card large event-small">
                            <div class="card-content">
                                <i class="material-icons event-small-type tooltipped" data-position="top" data-tooltip="Free">accessibility</i>
                                <a href="<?= Url::to(['user/view', 'id'=>$event->creator_id])?>" class="right ava-container-small tooltipped" data-position="top"
                            ...
                            <div class="card-action">
                                <div class="row no-margin-bot">
                                    <div class="col s12 m12">
                                        <a href="<?= Url::to(['event/view', 'id'=> $event->id])?>" class="full-width btn teal darken-2 waves-effect waves-light more-but">Подробнее</a>
                                    </div>
                                    <div class="col s12 m12">
                                        <button class="btn full-width modal-trigger orange waves-effect waves-light" data-target="participateModal">
                                            Участвовать
                                        </button>
                                    </div>
                                </div>
