                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'content' => function ($data) {
                                return
                                    Html::a('Подтвердить', ['confirm-particip', 'id' => $data->id], ['data-pjax' => 0])
                                    . ' | '
                                    . Html::a('Отказать', ['confirm-particip', 'id' => $data->id, 'confirm' => false,], ['data-pjax' => 0]);
                            }
                        ]
                    ],
                ]) ?>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'content' => function ($data) {
                            return
                                Yii::$app->user->can('updatePost', ['event' => $data->event]) ?
                                    Html::tag('div', Html::a('Отказать', ['confirm-particip', 'id' => $data->id, 'confirm' => false,], ['data-pjax' => 0]), ['class' => 'row'])
                                    : '';
                        }
                    ],
