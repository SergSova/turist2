    ...
    class m160506_102106_rbac_init extends \yii\db\Migration{
        ...
        public function up(){
            ...
            $this->createTable($authManager->itemTable, [
                ...
                'updated_at' => $this->integer(),
                'PRIMARY KEY (name)',
                'FOREIGN KEY (rule_name) REFERENCES '.$authManager->ruleTable.' (name)'.($this->isMSSQL() ? '' : ' ON DELETE SET NULL ON UPDATE CASCADE'),
            ], $tableOptions);
            ...
            $this->createTable($authManager->itemChildTable, [
                ...
                'FOREIGN KEY (parent) REFERENCES '.$authManager->itemTable.' (name)'.($this->isMSSQL() ? '' : ' ON DELETE CASCADE ON UPDATE CASCADE'),
                'FOREIGN KEY (child) REFERENCES '.$authManager->itemTable.' (name)'.($this->isMSSQL() ? '' : ' ON DELETE CASCADE ON UPDATE CASCADE'),
            ], $tableOptions);
